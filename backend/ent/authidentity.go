...
// was not loaded in eager-loading, or loaded but was not found.
func (e AuthIdentityEdges) AdoptionDecisionOrErr() (*IdentityAdoptionDecision, error) {
...
// QueryAdoptionDecision queries the "adoption_decision" edge of the AuthIdentity entity.
func (_m *AuthIdentity) QueryAdoptionDecision() *IdentityAdoptionDecisionQuery {
	return NewAuthIdentityClient(_m.config).QueryAdoptionDecision(_m)
}
