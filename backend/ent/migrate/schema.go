...
var (
	...
	IdentityAdoptionDecisionsColumns = []*schema.Column{
		...
		{Name: "identity_id", Type: field.TypeInt64, Unique: true},
	}
	...
	IdentityAdoptionDecisionsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "identity_adoption_decisions_auth_identities_adoption_decision",
	...
	PendingAuthSessionsColumns = []*schema.Column{
		...
		{Name: "provider_key", Type: field.TypeString, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "provider_subject", Type: field.TypeString, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "upstream_identity_payload", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "state_hash", Type: field.TypeString, Size: 255},
		{Name: "nonce", Type: field.TypeString, Size: 255},
	...
	PendingAuthSessionsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{PendingAuthSessionsColumns[13]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "pendingauthsession_state_hash",
				Unique:  true,
				Columns: []*schema.Column{PendingAuthSessionsColumns[8]},
			},
			{
				Name:    "pendingauthsession_nonce",
				Unique:  true,
				Columns: []*schema.Column{PendingAuthSessionsColumns[9]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{PendingAuthSessionsColumns[11]},
			},
			{
				Name:    "pendingauthsession_provider_type_provider_key_provider_subject",
				Unique:  false,
				Columns: []*schema.Column{PendingAuthSessionsColumns[4], PendingAuthSessionsColumns[5], PendingAuthSessionsColumns[6]},
			},
		},
	}
