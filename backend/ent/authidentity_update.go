...
func (_u *AuthIdentityUpdate) SetAdoptionDecisionID(id int64) *AuthIdentityUpdate {
...
func (_u *AuthIdentityUpdate) SetNillableAdoptionDecisionID(id *int64) *AuthIdentityUpdate {
	if id != nil {
...
func (_u *AuthIdentityUpdate) SetAdoptionDecision(v *IdentityAdoptionDecision) *AuthIdentityUpdate {
...
func (_u *AuthIdentityUpdate) ClearAdoptionDecision() *AuthIdentityUpdate {
...
func (_u *AuthIdentityUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AdoptionDecisionCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   authidentity.AdoptionDecisionTable,
			Columns: []string{authidentity.AdoptionDecisionColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetAdoptionDecisionID sets the "adoption_decision" edge to the IdentityAdoptionDecision entity by ID.
func (_u *AuthIdentityUpdateOne) SetAdoptionDecisionID(id int64) *AuthIdentityUpdateOne {
	_u.mutation.SetAdoptionDecisionID(id)
	return _u
}

// SetNillableAdoptionDecisionID sets the "adoption_decision" edge to the IdentityAdoptionDecision entity by ID if the given value is not nil.
func (_u *AuthIdentityUpdateOne) SetNillableAdoptionDecisionID(id *int64) *AuthIdentityUpdateOne {
	if id != nil {
		_u = _u.SetAdoptionDecisionID(*id)
	}
	return _u
...
// SetAdoptionDecision sets the "adoption_decision" edge to the IdentityAdoptionDecision entity.
func (_u *AuthIdentityUpdateOne) SetAdoptionDecision(v *IdentityAdoptionDecision) *AuthIdentityUpdateOne {
	return _u.SetAdoptionDecisionID(v.ID)
}
...
// ClearAdoptionDecision clears the "adoption_decision" edge to the IdentityAdoptionDecision entity.
func (_u *AuthIdentityUpdateOne) ClearAdoptionDecision() *AuthIdentityUpdateOne {
	_u.mutation.ClearAdoptionDecision()
	return _u
}
