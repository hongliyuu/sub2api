...
// QueryAdoptionDecision queries the adoption_decision edge of a AuthIdentity.
func (c *AuthIdentityClient) QueryAdoptionDecision(_m *AuthIdentity) *IdentityAdoptionDecisionQuery {
...
func (c *IdentityAdoptionDecisionClient) QueryIdentity(_m *IdentityAdoptionDecision) *AuthIdentityQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(authidentity.Table, authidentity.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, true, identityadoptiondecision.IdentityTable, identityadoptiondecision.IdentityColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
