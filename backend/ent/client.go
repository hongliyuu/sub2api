...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.UserReferralProfile, c.UserSubscription,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		Proxy, RedeemCode, ReferralRelation, SecuritySecret, Setting,
		TLSFingerprintProfile, UsageCleanupTask, UsageLog, User, UserAllowedGroup,
		UserAttributeDefinition, UserAttributeValue, UserReferralProfile,
