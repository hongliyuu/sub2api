...
func init() {
	...
	// accountDescReservedConcurrency is the schema descriptor for reserved_concurrency field.
	accountDescReservedConcurrency := accountFields[8].Descriptor()
	// account.DefaultReservedConcurrency holds the default value on creation for the reserved_concurrency field.
	account.DefaultReservedConcurrency = accountDescReservedConcurrency.Default.(int)
