...
func init() {
	...
	// accountDescPlanType is the schema descriptor for plan_type field.
	accountDescPlanType := accountFields[4].Descriptor()
	// account.PlanTypeValidator is a validator for the "plan_type" field. It is called by the builders before save.
	account.PlanTypeValidator = accountDescPlanType.Validators[0].(func(string) error)
	// accountDescSubscriptionStatus is the schema descriptor for subscription_status field.
	accountDescSubscriptionStatus := accountFields[5].Descriptor()
	// account.SubscriptionStatusValidator is a validator for the "subscription_status" field. It is called by the builders before save.
	account.SubscriptionStatusValidator = accountDescSubscriptionStatus.Validators[0].(func(string) error)
