...
func init() {
	...
	identityadoptiondecisionDescAdoptDisplayName := identityadoptiondecisionFields[1].Descriptor()
	...
	identityadoptiondecisionDescAdoptAvatar := identityadoptiondecisionFields[2].Descriptor()
	...
	identityadoptiondecisionDescDecidedAt := identityadoptiondecisionFields[3].Descriptor()
	...
	pendingauthsessionDescIntent := pendingauthsessionFields[0].Descriptor()
	...
	pendingauthsessionDescProviderType := pendingauthsessionFields[1].Descriptor()
	...
	pendingauthsessionDescProviderKey := pendingauthsessionFields[2].Descriptor()
	...
	pendingauthsessionDescProviderSubject := pendingauthsessionFields[3].Descriptor()
	...
	// pendingauthsessionDescUpstreamIdentityPayload is the schema descriptor for upstream_identity_payload field.
	pendingauthsessionDescUpstreamIdentityPayload := pendingauthsessionFields[4].Descriptor()
	// pendingauthsession.DefaultUpstreamIdentityPayload holds the default value on creation for the upstream_identity_payload field.
	pendingauthsession.DefaultUpstreamIdentityPayload = pendingauthsessionDescUpstreamIdentityPayload.Default.(func() map[string]interface{})
	// pendingauthsessionDescStateHash is the schema descriptor for state_hash field.
	pendingauthsessionDescStateHash := pendingauthsessionFields[6].Descriptor()
	// pendingauthsession.StateHashValidator is a validator for the "state_hash" field. It is called by the builders before save.
	pendingauthsession.StateHashValidator = func() func(string) error {
		validators := pendingauthsessionDescStateHash.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(state_hash string) error {
			for _, fn := range fns {
	...
	// pendingauthsessionDescNonce is the schema descriptor for nonce field.
	pendingauthsessionDescNonce := pendingauthsessionFields[7].Descriptor()
	// pendingauthsession.NonceValidator is a validator for the "nonce" field. It is called by the builders before save.
	pendingauthsession.NonceValidator = func() func(string) error {
		validators := pendingauthsessionDescNonce.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	pendingauthsessionDescRedirectTo := pendingauthsessionFields[8].Descriptor()
	...
	userDescSignupSource := userFields[2].Descriptor()
	...
	user.SignupSourceValidator = func() func(string) error {
		validators := userDescSignupSource.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(signup_source string) error {
			for _, fn := range fns {
				if err := fn(signup_source); err != nil {
					return err
				}
			}
			return nil
