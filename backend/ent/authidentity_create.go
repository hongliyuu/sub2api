...
func (_c *AuthIdentityCreate) SetAdoptionDecisionID(id int64) *AuthIdentityCreate {
...
func (_c *AuthIdentityCreate) SetNillableAdoptionDecisionID(id *int64) *AuthIdentityCreate {
	if id != nil {
...
func (_c *AuthIdentityCreate) SetAdoptionDecision(v *IdentityAdoptionDecision) *AuthIdentityCreate {
