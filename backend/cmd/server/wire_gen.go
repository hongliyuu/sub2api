...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	paymentCallbackService := service.NewPaymentCallbackService(client, redisClient, rechargeOrderRepository, userRepository, balanceLogRepository, emailService, settingService, balanceLotService, lotteryCouponRepository)
	...
	lotteryService := service.NewLotteryService(lotteryActivityRepository, lotteryParticipantRepository, lotteryCouponRepository, groupService, settingService, accountRepository, client, redisClient)
	lotteryDrawService := service.NewLotteryDrawService(lotteryActivityRepository, lotteryParticipantRepository, lotteryCouponRepository, userRepository, rechargeOrderRepository, userSubscriptionRepository, emailService, settingService, groupService, redisClient, client)
