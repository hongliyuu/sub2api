...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	referralService := service.NewReferralService(userRepository, settingService)
	...
	userHandler := handler.NewUserHandler(userService, emailService, emailCache, referralService)
