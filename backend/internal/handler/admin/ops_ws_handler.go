...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["nbapi-admin", "jwt.<token>"].
	// - We always select "nbapi-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"nbapi-admin"},
}
