...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/extreme-performance/status", h.Admin.Setting.GetExtremePerformanceStatus)
		adminSettings.POST("/extreme-performance/refill", h.Admin.Setting.TriggerExtremePerformanceRefill)
		adminSettings.POST("/extreme-performance/rebuild", h.Admin.Setting.TriggerExtremePerformanceRebuild)
		// 请求整流器配置
