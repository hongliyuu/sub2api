export default {
  ...
  auth: {
    ...
    wechat: {
      ...
      callbackHint: '如果页面未自动跳转，请返回登录页重试。',
      callbackMissingToken: '微信登录信息缺失，请返回重试。',
      invalidPendingToken: '微信登录会话已失效，请重新登录。',
      backToLogin: '返回登录'
    },
    wechatPayment: {
    ...
    thirdParty: {
      chooseActionHint: '请选择如何继续使用 {providerName} 登录。',
      unboundAccount: '当前 {providerName} 登录尚未绑定站内账号。',
      bindExistingAccount: '绑定已有账号',
      createNewAccount: '创建新账号',
      bindHint: '使用已有账号登录并绑定当前 {providerName} 登录。',
      createHint: '创建新账号并绑定当前 {providerName} 登录。',
      chooseAnotherAction: '选择其他方式',
      invitationRequired: '创建新的 {providerName} 账号前需要先填写邀请码。',
      bindSubmit: '登录并绑定',
      binding: '绑定中...',
      createSubmit: '创建账号',
      creating: '创建中...',
      bindFailed: '绑定账号失败，请检查登录信息后重试。',
      createFailed: '创建账号失败，请稍后重试。',
      invalidPendingToken: '登录会话已失效，请重新发起登录。',
      bindingOnly: '当前 {providerName} 流程仅用于绑定到已登录账号，不能在这里创建新账号。'
    },
    oauth: {
      code: '授权码',
      state: '状态',
  ...
  profile: {
    ...
    avatar: {
      title: '头像',
      description: '为个人资料页和顶部用户菜单上传自定义头像。',
      selectImage: '上传头像',
      uploading: '上传中...',
      remove: '移除头像',
      ready: '头像预览已准备好',
      empty: '当前使用昵称首字母占位',
      hint: '静态图片会在浏览器内自动压缩到 100 KB 以内后再上传。',
      formatsHint: '支持 JPG、PNG、WebP、GIF，上传上限为 100 KB。',
      gifHint: 'GIF 在文件本身不超过 100 KB 时可直接上传；更大的 GIF 暂不支持安全压缩。',
      sizeReady: '已准备上传：{size}',
      compressedReady: '已压缩后上传：{from} -> {to}',
      uploadSuccess: '头像更新成功',
      uploadFailed: '头像更新失败',
      removeSuccess: '头像已移除',
      removeFailed: '移除头像失败',
      invalidType: '请选择图片文件。',
      gifTooLarge: 'GIF 头像必须在 100 KB 以内。',
      compressTooLarge: '无法将图片压缩到 100 KB 以内，请换一张更小的图片。',
      compressFailed: '压缩所选图片失败。',
      readFailed: '读取所选图片失败。',
    },
    bindings: {
      title: '账户绑定',
      description: '查看当前账号已经关联的登录身份。',
      providers: {
        email: '邮箱',
        linuxdo: 'LinuxDo',
        wechat: '微信',
      ...
      connect: '去绑定',
      disconnect: '解除绑定',
      connected: '该身份已与当前账号关联。',
      connectedAs: '当前绑定：{value}',
      emailPrimary: '当前主登录邮箱',
      emailVerifiedValue: '{value}（已验证）',
      emailUnverifiedValue: '{value}（待验证）',
      providerDescriptions: {
        linuxdo: '将 LinuxDo 身份关联到当前账号，便于统一登录与找回。',
        wechat: '微信绑定入口会在账户系统后端就绪后显示。',
      },
      providerHints: {
        email: '这是当前账号的主身份信息。',
        linuxdo: '当新的账户绑定流程启用后，可在这里直接发起关联。',
        wechat: '共享账户系统暴露微信绑定能力后，这里会显示对应入口。',
      },
      providerDisabled: '公共设置中尚未启用该提供方。',
      providerPending: '后端返回新的账户绑定协议后，这里会显示完整管理操作。',
      disconnectSuccess: '已解除 {provider} 绑定',
  ...
  admin: {
    ...
    settings: {
      ...
      wechat: {
        title: '微信 Connect 登录',
        description:
          '配置微信公众号网页授权。这一组配置会同时服务微信登录/注册入口与微信内支付获取 openid，微信支付商户参数仍需单独配置。',
        enable: '启用微信登录',
        enableHint:
          '启用后会打开一套共享的公众号网页授权配置，既用于登录/注册的微信入口，也用于微信内支付在发起商户支付前获取 openid。',
        paymentUsageTitle: '同一套公众号配置同时服务登录和微信内支付',
        paymentUsageDesc:
          '这里的 AppID 和 AppSecret 会同时用于微信登录/注册，以及在 `wxpay` / `wxpay_direct` 发起前获取 openid。商户号、APIv3 Key、证书等微信支付参数仍在支付通道中单独维护。',
        paymentCompatibilityHint:
          '如果这里没有配置，其他支付方式仍可正常工作，但微信登录入口以及微信内 `wxpay` / `wxpay_direct` 的下单流程将无法完成。',
        ...
        presetBehaviorTitle: '已固定为公众号网页登录预设',
        presetBehaviorDesc:
          '管理后台不再暴露原始的 WeChat OAuth mode / scope 输入框。保存时会固定写入“公众号网页登录”预设，新的配置在留空时也会使用同一套后端默认值。',
        presetBehaviorHint:
          '登录/注册会统一走公众号网页授权；微信内支付在需要 openid 时，也会基于这套预设选择兼容的 scope。',
