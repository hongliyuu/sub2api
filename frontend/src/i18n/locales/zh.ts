export default {
  ...
  admin: {
    ...
    lottery: {
      ...
      loser: '未中奖',
      pending: '待开奖',
      drawConfirmTitle: '确认开奖',
      drawConfirmMessage: '确认手动开奖？此操作不可撤销。',
      drawSuccess: '开奖成功！中奖 {winners} 人 / 共 {total} 人',
      belowMinParticipants: '参与人数未达到最低要求',
      cancelConfirmTitle: '确认取消',
      cancelConfirmMessage: '确认取消活动？此操作不可撤销。',
      activityCreated: '活动创建成功',
      activityCancelled: '活动已取消',
      failedToLoad: '加载活动列表失败',
      failedToCreate: '创建活动失败',
      failedToDraw: '开奖失败',
      failedToCancel: '取消活动失败',
      failedToLoadParticipants: '加载参与者列表失败',
      detail: {
        userCategories: {
          new_user: '新用户',
          regular: '普通用户',
