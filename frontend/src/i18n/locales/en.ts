export default {
  ...
  admin: {
    ...
    lottery: {
      ...
      fields: {
        ...
        loserCoupon: 'Loser Coupon Amount (¥)',
        dailyLimit: 'Daily Limit (USD)',
        accountIds: 'Bind Accounts (optional)'
      },
      viewDetail: 'Details',
      ...
      drawConfirmMessage: 'Confirm manual draw? This action cannot be undone.',
      drawSuccess: 'Draw completed! {winners} winners / {total} total',
      belowMinParticipants: 'Below minimum participant requirement',
      cancelConfirmTitle: 'Confirm Cancel',
      cancelConfirmMessage: 'Confirm cancel? This action cannot be undone.',
      ...
      failedToDraw: 'Draw failed',
      failedToCancel: 'Failed to cancel activity',
  ...
  lottery: {
    ...
    detail: {
      ...
      prizeDesc: '{days}-day subscription trial',
      status: 'My Status',
